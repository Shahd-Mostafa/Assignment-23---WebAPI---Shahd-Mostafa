...
namespace Services
{
    public class ServiceManager(IBasketRepository _basketRepository, ICacheRepository _cacheRepository,UserManager<User> _userManager,IOptions<JwtOptions> _options,IUnitOfWork _unitOfWork, IMapper _mapper) : IServiceManager
    {
        ...
        private readonly Lazy<IAuthenticationService> _authenticationServices = new Lazy<IAuthenticationService>(() => new AuthenticationService(_userManager,_options));
